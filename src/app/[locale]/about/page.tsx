...
export default function AboutPage() {
  // Data Pembayaran & Game supaya kode tidak panjang
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#09090b] text-gray-800 dark:text-gray-200">
      <div className="max-w-6xl mx-auto px-6 py-16 space-y-24">
        ...
        {/* --- VALUE PROPOSITION --- */}
        <section className="grid md:grid-cols-2 gap-12 bg-gray-50 dark:bg-zinc-900/50 p-8 md:p-12 rounded-3xl border border-gray-100 dark:border-zinc-800">
          <div className="space-y-4">
            ...
            <p className="leading-relaxed font-medium text-purple-600 dark:text-purple-400">
          ...
          <div className="grid grid-cols-2 gap-4">
            {paymentMethods.map((method) => (
              <div
                key={method}
                className="flex  items-center justify-center p-3 bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-700 text-sm font-bold hover:scale-105 transition-transform cursor-default"
              >
                {method}
              </div>
            ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
            {popularGames.map((game) => (
              <div key={game} className="group space-y-3">
                ...
                <p className="text-sm font-bold opacity-80 group-hover:opacity-100">
                  {game}
                </p>
              </div>
            ))}
