  ...
  return (
    <a
      ...
      className={`
        ...
        hover:scale-105
        touch-manipulation
        max-xl:bottom-[calc(0.625rem+env(safe-area-inset-bottom,0px)+max(3.25rem,var(--mobile-order-bar-height,0px)))]
        xl:bottom-[calc(3.5rem+env(safe-area-inset-bottom,0px))]
      `}
      aria-label="Chat CS"
    >
      ...
      <span className="hidden text-sm font-medium sm:inline">Chat CS</span>
    </a>
  )
}
